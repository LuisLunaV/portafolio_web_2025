<template>
  <div class="mis-tecnologias amarillo-mate">
    <div class="titulo-subtitulo mb-3">
      <h1 class="color-negro-suave poppins-bold pb-2">Conocimientos técnicos y habilidades.</h1>
      <p class="color-negro-suave poppins-semibold p-2">
        Habilidades tecnicas que he ido dominando con base a mi experiencia laboral y proyectos
        personales.
      </p>
    </div>
