<template>
  ...
  <CelularPc
    v-if="(dispositivo == 'pequeno' && estaAbierto) || (dispositivo == 'expequeno' && estaAbierto)"
    :estaAbierto="estaAbierto"
    @cerrarVentada="mostrarSobreMi"
  />
  <div class="div-contenedor-inicios">
          ...
          <span
            :class="[
              'poppins-extrabold px-1',
              {
                ...
                'tamano-movil': dispositivo == 'pequeno' || dispositivo == 'expequeno',
              },
            ]"
          >
        ...
        <div class="box div-inicio-subtitulo">
          <span
            :class="[
              'poppins-semibold',
              {
                'fs-1': dispositivo == 'grande' || dispositivo == 'pequeno',
    ...
    <div class="additional-info">
      <p>© 2025 - Luis Alfredo Luna Villa - México</p>
    </div>
  </div>
</template>
